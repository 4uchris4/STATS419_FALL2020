...
\KeywordTok{buildLatexCorrelationTable}\NormalTok{(myData, }
  ...
  \DataTypeTok{width.table =} \FloatTok{0.75}\NormalTok{, }\CommentTok{\# best for given data ... 0.95 when rotateTable = FALSE}
...
\KeywordTok{buildLatexCorrelationTable}\NormalTok{(myData, }
  ...
  \DataTypeTok{width.table =} \FloatTok{0.85}\NormalTok{,}
  \DataTypeTok{myFile =}\NormalTok{ file.correlation,}
